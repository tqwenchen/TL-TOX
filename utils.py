...
def get_blosum62(seq):
    ...
    # print("shape of blosum:", blosum.shape) # shape of blosum: (193, 20) -> from 第一行的sequence
    # blosum = normalization(blosum)
    feature = np.zeros((1002,20))
    idx = blosum.shape[0] #193
    feature[0:idx,:] = blosum
    # print("shape of feature:", feature.shape) #shape of feature: (1002, 20)
    return feature
